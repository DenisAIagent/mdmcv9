...
const LandingPageGenerator = () => {
  ...
  const templates = [
    { id: 'music-artist', name: t('admin.landing_page.template_music_artist'), image: '/assets/images/template-artist.jpg' },
    { id: 'album-release', name: t('admin.landing_page.template_album_release'), image: '/assets/images/template-album.jpg' },
    { id: 'music-event', name: t('admin.landing_page.template_music_event'), image: '/assets/images/template-event.jpg' },
    { id: 'music-promotion', name: t('admin.landing_page.template_music_promotion'), image: '/assets/images/template-promotion.jpg' }
  ];
