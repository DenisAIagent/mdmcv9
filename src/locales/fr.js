...
export default {
  ...
  "reviews": { // Section Avis Publics
    ...
    "loading_gmb": "Chargement des avis Google My Business..."
  },
  "footer": {
    "rights": "Tous droits réservés",
    "privacy": "Politique de confidentialité",
    "terms": "Conditions d'utilisation",
    "copyright": "MDMC OÜ - MDMC Music Ads. Tous droits réservés.",
  ...
  "cookies": {
    "message": "Nous utilisons des cookies pour améliorer votre expérience sur notre site. En continuant votre navigation, vous acceptez notre utilisation des cookies conformément à notre politique de confidentialité.",
  ...
  "faq": {
    "title": "Questions Fréquentes sur le Marketing Musical",
    "subtitle": "Tout ce que vous devez savoir sur nos services YouTube Ads, Meta Ads et TikTok Ads pour artistes et labels",
    "page_title": "Questions Fréquentes - Marketing Musical MDMC",
    "page_description": "Toutes les réponses à vos questions sur nos services YouTube Ads, Meta Ads et TikTok Ads pour artistes et labels. Expertise marketing musical depuis plus de 10 ans.",
    "help_title": "Besoin d'aide supplémentaire ?",
    "help_text": "Si vous ne trouvez pas la réponse à votre question, notre équipe d'experts est là pour vous aider.",
    "help_contact": "Nous contacter",
    "help_calendar": "Réserver un appel",
    "intro": {
      "title": "Pourquoi choisir MDMC Music Ads pour votre marketing musical ?",
      "text": "Notre équipe travaille dans la musique depuis plus de 10 ans et sont d'anciens salariés de Google et Meta. Nos experts maîtrisent parfaitement les algorithmes de YouTube, Meta (Facebook/Instagram) et TikTok pour maximiser la visibilité de votre musique. Que vous soyez artiste indépendant ou label établi, nous adaptons nos stratégies à vos objectifs et votre budget."
    },
    "q1": {
      "question": "Combien coûte une campagne YouTube Ads pour artiste ?",
    ...
    "q2": {
      "question": "Quels résultats puis-je attendre avec Meta Ads (Facebook/Instagram) ?",
  ...
  "admin": {
    ...
    "settings": "Paramètres", // Clé simple pour le bouton sidebar
    "logout": "Déconnexion",
  ...
  "meta_ads": {
    ...
    "hero": {
      ...
      "cta_primary": "Simuler ma campagne Meta",
      "cta_secondary": "Lancer ma promo Meta",
      "trust_items": {
        "no_fake": "Aucun achat de vues",
        "real_fans": "Fans réels uniquement",
        "roi": "ROI garanti"
      }
    },
    "form": {
      "title": "Estimation Gratuite Meta Ads",
      "subtitle": "Obtenez votre budget optimal en 30 secondes",
      "artist_label": "Nom d'artiste",
      "artist_placeholder": "Ex: MC Flow",
      "email_label": "Email",
      "email_placeholder": "votre@email.com",
      "genre_label": "Genre musical",
      "genre_placeholder": "Sélectionnez votre genre",
      "submit": "Simuler ma campagne"
    },
    "services": [
      {
        "title": "Campagnes Facebook Ads",
        "description": "Ciblage précis de votre audience musicale sur Facebook avec des créatives optimisées pour l'engagement et la conversion"
      },
      {
        "title": "Instagram Music Marketing",
        "description": "Promotion native sur Instagram avec Stories, Reels et posts pour maximiser votre visibilité auprès des mélomanes"
      },
      {
        "title": "Publicités Vidéo Meta",
        "description": "Clips courts optimisés pour Facebook et Instagram, conçus pour générer des streams et fidéliser vos fans"
      },
      {
        "title": "Retargeting Musical",
        "description": "Reciblage intelligent de vos auditeurs existants pour transformer l'intérêt en abonnement et achat"
      }
    ],
    "faq": {
      "title": "Questions fréquentes",
  ...
  "youtube_ads": {
    ...
    "hero": {
      ...
      "title_line2": "pour Artistes",
      "promise_main": "Place ton clip devant ton public.",
      "promise_sub": "Pas devant n'importe qui.",
      "cta_primary": "Simuler ma campagne YouTube",
      "cta_secondary": "Lancer ma promo YouTube",
      "trust_items": {
        "no_fake": "Aucun achat de vues",
        "real_fans": "Fans réels uniquement",
        "roi": "ROI garanti"
    ...
    "form": {
      "title": "Estimation Gratuite YouTube Ads",
      "subtitle": "Obtenez votre budget optimal en 30 secondes",
      "artist_label": "Nom d'artiste",
      "artist_placeholder": "Ex: MC Flow",
      "email_label": "Email",
    ...
    "services": [
      {
        "title": "Campagnes Video Ads",
        "description": "Promotion de vos clips musicaux avec ciblage précis des mélomanes de votre genre"
      },
      {
        "title": "Publicités Pre-Roll",
        "description": "Annonces avant les vidéos pour maximiser la découvrabilité de votre musique"
      },
      {
        "title": "YouTube Shorts Ads",
        "description": "Promotion sur le format viral de YouTube pour toucher la Gen Z et nouveaux fans"
      },
      {
        "title": "Remarketing YouTube",
        "description": "Reciblage intelligent pour convertir les spectateurs en abonnés fidèles"
      }
    ],
    "faq": {
      "title": "Questions fréquentes",
      "items": [
        {
          "question": "Combien coûte une campagne YouTube Ads pour musiciens ?",
          "answer": "Les budgets YouTube Ads commencent à partir de 300€. Nous recommandons un minimum de 600€ sur 30 jours pour optimiser les performances et générer des vues qualifiées de votre genre musical."
        },
        {
          "question": "Mes vues YouTube seront-elles authentiques ?",
          "answer": "Absolument. Nous ciblons uniquement des spectateurs réels intéressés par votre style musical. Aucune vue artificielle. Nos campagnes génèrent des vues organiques qui comptent pour le référencement YouTube."
        },
        {
          "question": "Mon clip doit-il être optimisé pour YouTube ?",
          "answer": "Pas nécessairement. Nous optimisons vos visuels, titres, descriptions et ciblages pour maximiser l'impact sur YouTube. Votre créativité + notre expertise YouTube = résultats garantis."
        },
        {
          "question": "Combien de temps pour voir les premiers résultats ?",
          "answer": "Les premières vues arrivent en 24-48h. Les résultats significatifs (abonnés, engagement, partages) se manifestent généralement sous 7-14 jours selon votre budget et ciblage."
        }
      ]
    }
  },
  ...
  "release_planner": {
    ...
    "subtitle": "Optimisez votre sortie avec l'IA prédictive",
    "close": "×",
    "faq_toggle": "FAQ",
    "steps": {
      "project": "Projet",
    ...
    "step1": {
      ...
      "subtitle": "Décrivez les caractéristiques de votre sortie.",
      ...
      "territories": "Territoires visés",
      "territories_help": "Maintenez Ctrl (Cmd sur Mac) pour sélectionner plusieurs territoires.",
      "next": "Suivant"
    },
    "step2": {
      "title": "Période de Sortie",
      "subtitle": "Quand souhaitez-vous sortir votre projet ?",
      "month": "Mois de sortie souhaité",
      "month_placeholder": "Sélectionnez le mois",
      "next": "Suivant",
      "previous": "Précédent"
    },
    "step3": {
      "title": "Vos Coordonnées",
      "subtitle": "Pour recevoir votre analyse personnalisée.",
      "artist_name": "Nom d'artiste",
      "artist_placeholder": "Votre nom d'artiste",
      "email": "Email",
      "email_placeholder": "votre@email.com",
      "newsletter": "Recevoir nos conseils marketing musical",
      "analyze": "Analyser mon projet",
      "previous": "Précédent"
    },
    "step4": {
      "title": "Analyse en cours...",
      "analyzing": "Nous analysons votre projet musical et générons vos recommandations personnalisées.",
      "wait": "Veuillez patienter quelques secondes."
    },
    "results": {
      "title": "Votre Stratégie Spotify Personnalisée",
      "score": "Score de Potentiel",
      "score_suffix": "/100",
      "recommendations": "Recommandations",
      "calendar": "Réserver un appel stratégique",
      "calendar_subtitle": "Discutons de votre projet en détail",
